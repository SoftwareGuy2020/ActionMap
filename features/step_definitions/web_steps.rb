...
When(/^I clink on News Articles for (.+)$/) do |_representative|
    visit '/representatives/1000000/news_items'
end

Given(/the following representatives exist/) do |representative|
    representative.hashes.each do |repr|
        Representative.create!(repr)
    end
end
